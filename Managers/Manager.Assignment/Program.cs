using Manager.Assignment.Consumers;
...
// Add HTTP client for Assignment validation with correlation ID support
...
builder.Services.AddScoped<IOrchestratedFlowValidationService, OrchestratedFlowValidationService>();
...
try
{
    ...
    logger.LogInformation("Starting AssignmentManager API");
    app.Run();
}
catch (Exception ex)
{
