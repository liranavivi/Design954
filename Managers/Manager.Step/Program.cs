...
builder.Services.AddScoped<IProcessorValidationService, ProcessorValidationService>();
...
startupLogger.LogInformationWithCorrelation("ManagerMetricsService initialized early to register meters with OpenTelemetry");
...
try
{
    ...
    logger.LogInformation("Starting StepManager API");
    app.Run();
}
catch (Exception ex)
{
